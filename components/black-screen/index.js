const blackIconTemplate = document.createElement("template")
blackIconTemplate.innerHTML = /* html */ `
 <style>
   .container {
     position: relative;
   }
...
class BlackScreen extends HTMLElement {
 constructor() {
   ...
   this.shadowRoot.appendChild(blackIconTemplate.content.cloneNode(true));
