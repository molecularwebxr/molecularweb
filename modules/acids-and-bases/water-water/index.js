...
AFRAME.registerComponent("update-stuff", {
  ...
  tick: function(t) {
    ...
    const vaterOrbitalsA = [this.vatorb2A, this.vatorb3A, this.vatorb4A, this.vatorb5A];
    const vaterOrbitalsB = [this.vatorb2B, this.vatorb3B, this.vatorb4B, this.vatorb5B];
    ...
    const vaterAPositions = [this.vat2APosition, this.vat3APosition, this.vat4APosition, this.vat5APosition];
    const vaterBPositions = [this.vat2BPosition, this.vat3BPosition, this.vat4BPosition, this.vat5BPosition];
     ...
     const vaterPositions = vaterSide === "A" ? vaterAPositions : vaterBPositions;
        ...
        // Make bridge visible and set its src/dest
         ...
         [...this.connectors].forEach((connector, index) => {
          connector.setAttribute(
            "connector",
            `src: #vat${closestVater + 2}${vaterSide}; dest: #wat${closestWater + 2}${waterSide}; alpha: ` + index / 10,
          );
        });
